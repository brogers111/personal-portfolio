    ...
    <section className='md:hidden pb-10'>
      <div className='flex gap-6 py-4 justify-center'>
        <a
          ...
          rel='noopener noreferrer'
          aria-label="Visit my LinkedIn profile"
          className="font-dongle text-xl text-gray-400 inline-flex items-baseline gap-1"
        >
          LinkedIn
          <FontAwesomeIcon className='size-[0.6rem]' icon={faArrowUpRightFromSquare} />
        </a>
      ...
      <div>
        <h1 className="pt-4 px-6 font-dongle text-3xl text-gray-300">HEY, I'M<br/><span className="font-bluffolk text-6xl text-gray-600">BRANDON</span></h1>
