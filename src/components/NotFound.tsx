  ...
  return (
    <>
      ...
      <section className="hidden md:flex flex-col justify-center min-h-screen">
        ...
        <Link to="/" className="mt-4 ml-24 font-dongle text-2xl text-gray-600 underline underline-offset-4 hover:text-gray-800 transition-colors w-fit">
          Go back home
        </Link>
      </section>
      ...
      <section className="md:hidden pb-10 px-10 pt-20">
        ...
        <Link to="/" className="mt-4 block font-dongle text-xl text-gray-600 underline underline-offset-4">
          Go back home
        </Link>
      </section>
    </>
